export const app = {
  ...
  chat: {
    ...
    images: {
      ...
      cancel: '取消生成',
      regenerate: '重新生成',
      regenerateNotice: '将发起新的模型请求。',
      reselectModel: '重新选择模型',
      reselectSources: '重新选择素材',
      recoveryNotice: '重新生成仍使用原模型与素材。更换模型后，请在输入区明确指定模型并重新发送；更换素材可上传附件，或在历史图片上点击“继续修改”。',
      ...
      cancelTooLateNotice: '取消未生效，已生成并保存图片。',
      unconfirmedNotice: '暂时无法确认结果，请在重新发起请求前核对。',
      details: '请求详情',
      sources: '{{count}} 张来源图片',
      states: { running: '正在生成图片', saving: '正在保存图片', completed: '图片已保存', cancelling: '正在取消生成', stopped: '已停止等待', failed: '图片生成失败', unconfirmed: '结果未确认' },
      contextNotice: {
  ...
  markdown: {
    ...
    mermaidExportPng: '导出 PNG',
    mermaidExporting: '正在导出 PNG…',
    mermaidExportError: '导出失败，请点击“导出 PNG”重试。',
    htmlPreview: 'HTML 预览',
