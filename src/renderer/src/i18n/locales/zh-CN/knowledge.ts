export const knowledge = {
  external: {
    close: '关闭实例管理', deleteInstanceTitle: '删除实例“{{name}}”？',
    clearSearch: '清除搜索', noResultsHelp: '换一个名称搜索，或清除搜索查看可用知识库。',
    emptyHelp: '请检查远端服务的访问权限，或手工填写已知的知识库 ID。',
    sourceFilter: '知识库来源筛选', clearFilters: '清除筛选', weightedScore: '加权分数',
    saveThenTest: '保存实例后，可在实例列表中测试连接。',
    rebindConfirm: '将此绑定保存为新选择的远端知识库，远端数据不会改变。',
    probe: { untested: '未测试', 'catalog-ready': '目录可用', healthy: '连接正常', 'list-restricted': '目录受限，可手工填写知识库 ID', 'auth-failed': '认证失败', unreachable: '服务无法连接', failed: '连接失败' },
    credentials: { configured: '已配置凭据', missing: '缺少凭据', unavailable: '凭据不可用' },
    manage: '管理外部实例', instances: '外部实例', addInstance: '添加实例',
    type: '知识库类型', local: '本地', provider: 'Provider', instance: '外部实例',
    editInstance: '编辑实例', authentication: '身份认证', credentialAction: '已保存凭据', connectionHelp: '如何测试连接',
    enabledHelp: '启用后，关联知识库的检索查询将发送到此服务。',
    address: '服务地址', credential: 'API Key', keep: '保留已保存凭据', replace: '替换凭据', clear: '清除凭据',
    ...
    manual: '手工填写知识库 ID', browse: '从目录选择', search: '搜索远端知识库', refresh: '刷新知识库列表',
    loading: '正在读取知识库…', empty: '当前实例没有可访问的知识库', noResults: '没有符合条件的结果',
    next: '下一页', previous: '上一页', root: '返回根目录', folder: '打开文件夹', alreadyBound: '已添加',
    verify: '验证知识库', source: '知识库来源', config: '检索配置', common: '通用配置',
    resultLimit: '返回片段数', timeout: '请求超时（毫秒）', snippetLimit: '单片段字符上限',
    localOnly: '参数仅保存在 GoodBuddy，用于此绑定的后续检索，不会修改远端知识库设置。',
    queryNote: '只向所选实例发送当前查询，不上传文件或完整会话，不调用 GoodBuddy 模型。检索可能产生远端 Embedding、Rerank 用量及 API 使用记录。',
    query: '测试查询', test: '测试检索', testing: '正在测试…', tested: '检索成功，返回 {{count}} 条片段',
    untested: '请填写查询并成功测试检索后保存。零条结果也可保存。保存时会再次发送查询，验证当前参数。',
    add: '添加知识库', saveConfig: '保存检索参数', defaults: '恢复默认',
    datasetDefaults: '使用知识库默认配置', datasetDefaultsHelp: '每次检索沿用远端当前设置，远端设置变化会影响结果。',
    searchMethod: '检索方式', topK: 'Provider Top K', thresholdEnabled: '启用分数阈值', threshold: '相似度阈值',
    rerank: '启用 Rerank', rerankMode: '重排方式', rerankProvider: '重排模型提供商', rerankModel: '重排模型',
    keywordWeight: '关键词权重', vectorWeight: '向量权重', embeddingProvider: 'Embedding 提供商', embeddingModel: 'Embedding 模型',
    tokenLimit: 'Token 上限', knnTopK: 'KNN Top K', rerankId: '远端重排模型 ID', rerankCandidates: '重排候选数量',
    graph: '图谱检索', graphHelp: '检索远端已生成的图谱，不会创建或更新图谱。', graphUnknown: '未确认远端图谱已完成',
    compilation: '包含 Knowledge Compilation', compilationUnavailable: '当前知识库未确认配置 Knowledge Compilation',
    overview: '概览', rebind: '更换远端知识库', refreshDetail: '刷新远端信息', remove: '从 GoodBuddy 移除',
    removeBindingConfirm: '仅删除本机绑定和检索配置，不删除远端知识库或文档。历史会话中的引用继续可读。',
    deleteInstance: '删除实例和本地绑定', deleteInstanceConfirm: '此实例被 {{count}} 个知识库使用。删除会同时移除本机绑定，远端数据不会改变。',
    cancelRequest: '取消请求', remoteData: '知识内容保留在远端；回答使用的片段随会话保存在本机。',
    status: '状态', credentialStatus: '凭据状态', boundCount: '{{count}} 个绑定', lastTest: '最近测试', never: '尚未检索',
  ...
  page: {
    title: '知识库',
    description: '管理本地知识，并检索企业现有知识平台。'
  },
  actions: {
    cancel: '取消',
    createLibrary: '创建知识库',
