export const heartbeat = {
  reviewSettings: {
    ...
    pauseHelp: '执行时间达到软预算后，正在处理的批次完成并保存，再暂停；可从活动记录继续。',
    invalid: '请输入所示范围内的整数。',
    ...
    configurationValues: '每次读取 {{pageSize}} 个来源；每批文本量 {{batchCharacters}}，最多 {{batchMessages}} 条消息；整理 {{executionSeconds}} 秒后暂停；模型超时 {{timeoutSeconds}} 秒；最多同时处理 {{concurrency}} 个任务。实际并发还受当前监督模型并发设置限制。',
