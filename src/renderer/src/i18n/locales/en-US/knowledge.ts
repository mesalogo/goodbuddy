...
export const knowledge = {
  external: {
    close: 'Close instance manager', deleteInstanceTitle: 'Delete instance “{{name}}”?',
    clearSearch: 'Clear search', noResultsHelp: 'Try a different name or clear the search to see available libraries.',
    emptyHelp: 'Check access on the remote service, or enter a known library ID manually.',
    sourceFilter: 'Library source filter', clearFilters: 'Clear filters', weightedScore: 'Weighted score',
    saveThenTest: 'Save the instance, then use Test connection in the instance list.',
    rebindConfirm: 'Save this binding with the newly selected remote library. Remote data will not change.',
    probe: { untested: 'Not tested', 'catalog-ready': 'Catalog available', healthy: 'Connected', 'list-restricted': 'Catalog restricted; enter a library ID manually', 'auth-failed': 'Authentication failed', unreachable: 'Service unreachable', failed: 'Connection failed' },
    credentials: { configured: 'Credential configured', missing: 'Credential missing', unavailable: 'Credential unavailable' },
    manage: 'Manage external instances', instances: 'External instances', addInstance: 'Add instance',
    type: 'Library type', local: 'Local', provider: 'Provider', instance: 'External instance',
    editInstance: 'Edit instance', authentication: 'Authentication', credentialAction: 'Saved credential', connectionHelp: 'How to test the connection',
    enabledHelp: 'Enabled bindings send retrieval queries to this service.',
    address: 'Service URL', credential: 'API Key', keep: 'Keep saved credential', replace: 'Replace credential', clear: 'Clear credential',
    ...
    manual: 'Enter library ID manually', browse: 'Choose from catalog', search: 'Search remote libraries', refresh: 'Refresh library catalog',
    loading: 'Loading libraries…', empty: 'No accessible libraries in this instance', noResults: 'No matching results',
    next: 'Next page', previous: 'Previous page', root: 'Back to root', folder: 'Open folder', alreadyBound: 'Already added',
    verify: 'Verify library', source: 'Library source', config: 'Retrieval settings', common: 'Common settings',
    resultLimit: 'Returned snippets', timeout: 'Request timeout (ms)', snippetLimit: 'Maximum characters per snippet',
    localOnly: 'Settings are saved only in GoodBuddy for subsequent retrievals through this binding. They do not change remote library settings.',
    queryNote: 'Only the current query is sent to the selected instance. Files and full conversations are not uploaded, and no GoodBuddy model is called. Retrieval may incur remote Embedding, Rerank usage and API records.',
    query: 'Test query', test: 'Test retrieval', testing: 'Testing…', tested: 'Retrieval succeeded with {{count}} snippets',
    untested: 'Enter a query and successfully test retrieval before saving. Zero results also allow saving. Saving runs the query again to verify the current settings.',
    add: 'Add library', saveConfig: 'Save retrieval settings', defaults: 'Restore defaults',
    datasetDefaults: 'Use dataset defaults', datasetDefaultsHelp: 'Each request uses the current remote settings. Remote changes will affect results.',
    searchMethod: 'Search method', topK: 'Provider Top K', thresholdEnabled: 'Enable score threshold', threshold: 'Similarity threshold',
    rerank: 'Enable Rerank', rerankMode: 'Reranking mode', rerankProvider: 'Reranking provider', rerankModel: 'Reranking model',
    keywordWeight: 'Keyword weight', vectorWeight: 'Vector weight', embeddingProvider: 'Embedding provider', embeddingModel: 'Embedding model',
    tokenLimit: 'Token limit', knnTopK: 'KNN Top K', rerankId: 'Remote reranking model ID', rerankCandidates: 'Rerank candidates',
    graph: 'Graph retrieval', graphHelp: 'Search existing remote graph content without creating or updating the graph.', graphUnknown: 'Completed remote graph not confirmed',
    compilation: 'Include Knowledge Compilation', compilationUnavailable: 'Knowledge Compilation configuration not confirmed for this library',
    overview: 'Overview', rebind: 'Change remote library', refreshDetail: 'Refresh remote details', remove: 'Remove from GoodBuddy',
    removeBindingConfirm: 'Only the local binding and retrieval settings are deleted. Remote libraries and documents are preserved. Historical conversation citations remain readable.',
    deleteInstance: 'Delete instance and local bindings', deleteInstanceConfirm: 'This instance is used by {{count}} libraries. Deletion also removes their local bindings. Remote data will not change.',
    cancelRequest: 'Cancel request', remoteData: 'Knowledge stays on the remote service. Snippets used in answers are saved locally with the conversation.',
    status: 'Status', credentialStatus: 'Credential status', boundCount: '{{count}} bindings', lastTest: 'Last test', never: 'Not retrieved yet',
  ...
  page: {
    ...
    description: 'Manage local knowledge and retrieve from existing enterprise knowledge services.'
  },
  actions: {
    cancel: 'Cancel',
