...
export const app = {
  ...
  chat: {
    ...
    images: {
      ...
      regenerateNotice: 'Starts a new model request.',
      reselectModel: 'Choose another model',
      reselectSources: 'Choose source images',
      recoveryNotice: 'Generate again keeps the original model and sources. To change the model, name it explicitly in a new composer request. To change sources, upload attachments or choose Continue editing on a previous image.',
      ...
      cancelTooLateNotice: 'Cancellation did not take effect. The generated image has been saved.',
      unconfirmedNotice: 'The result could not be confirmed. Check before starting another request.',
      details: 'Request details',
      sources: '{{count}} source images',
      states: { running: 'Generating image', saving: 'Saving image', completed: 'Image saved', cancelling: 'Cancelling generation', stopped: 'Stopped waiting', failed: 'Image generation failed', unconfirmed: 'Result unconfirmed' },
      contextNotice: {
