...
describe("App", () => {
  ...
  it("adds a new external binding to the current selection without re-enabling an excluded library", async () => {
    ...
    const instance = { id: 'instance-1', name: 'Company Dify', provider: 'dify' as const, baseUrl: 'https://knowledge.example', enabled: true, credentialStatus: 'configured' as const, probeStatus: 'catalog-ready' as const, bindingCount: 0 };
