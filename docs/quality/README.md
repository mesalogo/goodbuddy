...
本目录收录跨功能测试方法。功能验收结果仍记录在对应功能的 `progress.md`，不在此复制通过记录。
...
| [真实 Runtime 测试](../../BUILD.md#质量验证) | 真实模型 Runtime E2E 的现有入口及范围 |
| [发布操作](../development/release-runbook.md) | 候选 CI、发布构建及发布验证；开发期 UI 测试不替代发布检查 |
