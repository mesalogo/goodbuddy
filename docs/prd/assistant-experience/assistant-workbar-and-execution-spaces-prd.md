...
| 日期 | 2026-08-31 |
| 适用产品 | GoodBuddy 桌面端 |
| 相关设计 | [统一界面设计系统](../../../UI-DESIGN.md)、[SSH 远程主机与 GoodBuddy Agent 实现说明](../../architecture/remote-host-and-goodbuddy-agent-design.md) |
...
用户再创建或激活应用实例。详细交互以
[助手工作栏多终端页签 PRD](./workbar-terminal-tabs-prd.md) 为准。
...
或放弃编辑。地址草稿不属于浏览器会话持久状态，也不需要恢复或版本化机制。
...
- [助手工作栏多终端页签 PRD](./workbar-terminal-tabs-prd.md) 定义持久“+”、应用实例策略、
