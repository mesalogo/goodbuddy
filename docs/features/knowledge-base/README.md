...
后续与监督者的关系：故事线图谱引用现有知识库资料，补充工作事件与知识演变视图；计划支持双向定位和预览后补充本地条目，不复制资料正文、不改变外部知识库只读边界。该集成尚未实现，权威定义见[监督者产品设计](../conversation-supervision/supervisor-prd.md) FR-S7 至 FR-S9。
